  ...
  factory: (require) => {
    ...
    if (typeof document !== "undefined" && document.getElementById("dsh-md-annotator-style") === null) {
      ...
      styleEl.textContent = [
        ...
        ".mdan-bar{display:flex;align-items:center;gap:8px;flex:none;margin:10px -12px 0;padding:8px 12px;background:var(--dsw-alias-bg-base);border-top:1px solid var(--dsw-alias-border-l1)}",
